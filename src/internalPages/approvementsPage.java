...
public class approvementsPage extends javax.swing.JInternalFrame {
    ...
    public void displayData(){
        try{
            ...
            approvement_table.setModel(DbUtils.resultSetToTableModel(rs));
             rs.close();
    ...
    private void initComponents() {
        ...
        approvement_table = new javax.swing.JTable();
        ...
        jScrollPane1.setViewportView(approvement_table);
    ...
    private void editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editMouseClicked
        int rowIndex = approvement_table.getSelectedRow();
        if(rowIndex < 0){
            JOptionPane.showMessageDialog(null, "Please Select an Item!");
        }else{
            TableModel model = approvement_table.getModel();
            userForm stf = new userForm();
    ...
    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
        ...
        try {
            approvement_table.print(JTable.PrintMode.NORMAL, head, FOOT);
    ...
    private javax.swing.JTable approvement_table;
